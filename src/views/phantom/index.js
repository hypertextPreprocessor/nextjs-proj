...
export default function PhantomCom(){
    ...
    return <div className="w-full h-dvh bg-[#111011] text-[#efeeef] flex flex-col">
        <div className="flex py-3 px-3 items-center">
            ...
            <div className="flex gap-2 w-full flex-3">
        ...
        <div className="px-4 flex-1 flex flex-col gap-2 justify-center items-center">
            <h1 className="text-2xl font-bold">{t("phantom.title")}</h1>
            <p className="text-lg px-2 text-[#b3b4b5]">{t("phantom.desc")}</p>
            <p className="w-full"><textarea ref={textareaRef} onChange={()=>{
                setDisabled(false);
            }} rows="7" name="phrase" id="phrase" className="text-lg p-2 w-full bg-[#232123] border-solid border-2 border-[#383739] rounded-xl outline-[#383739]"/></p>
