...
export default function TvGardenCom(){
    ...
    return <div className="bg-black">
        <div className="w-full text-white mx-auto">
            <div className="border-y-[#79c447] border-y border-solid">
                    ...
                    <p className="flex items-center gap-2">
                        ...
                        {pageAttr.device.isDesktop?
                            <ul className="flex text-base px-2 gap-8 has-[li]:cursor-pointer">
                                ...
                                <li className="hover:text-[#2bba3f]">Download</li>
            ...
            <div className="xl:max-w-7xl 3xs:max-sm:w-9/10  mx-auto border border-[#aaa] mt-8 bg-[#1a202c]">
                ...
                <div className="px-2">
                    <ul className="text-[#79c447] list-decimal pl-2 [&_ul]:list-decimal xl:[&_ul]:pl-6 3xs:max-sm:[&_ul]:pl-4 [&_li]:py-2 [&_li_p]:hover:text-white [&_li_p]:hover:underline [&_li_p]:border-b [&_li_p]:border-b-[#ffffff1a]">
                        <li className="mx-2">
                            <p><a href="https://tv-garden-new5.online/index.html#tv-garden-live-tv-news-sports-more8230" target="_blank">{t("tvgarden.li1")}</a></p>
                            <ul>
                                <li><p><a href="https://tv-garden-new5.online/index.html#tv-garden-live-tv-news-sports-more8230" target="_blank">{t("tvgarden.li2")}</a></p></li>
                                <li><p><a href="https://tv-garden-new5.online/index.html#tv-garden-live-tv-news-sports-more8230" target="_blank">{t("tvgarden.li3")}</a></p></li>
                                <li>
                                    <p><a href="">{t("tvgarden.li4")}</a></p>
                                    <ul>
                                        <li><p><a href="">{t("tvgarden.li5")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li6")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li7")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li8")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li9")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li10")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li11")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li12")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li13")}</a></p></li>
                                    </ul>
                                </li>
                                <li><p><a href="">{t("tvgarden.li14")}</a></p></li>
                                <li><p><a href="">{t("tvgarden.li15")}</a></p></li>
                                <li>
                                    <p><a href="">{t("tvgarden.li16")}</a></p>
                                    <ul>
                                        <li><p><a href="">{t("tvgarden.li17")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li18")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li19")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li20")}</a></p></li>
                                    </ul>
                                </li>
                                <li><p><a href="">{t("tvgarden.li21")}</a></p></li>
                                <li><p><a href="">{t("tvgarden.li22")}</a></p></li>
                                <li>
                                    <p><a href="">{t("tvgarden.li23")}</a></p>
                                    <ul>
                                        <li><p><a href="">{t("tvgarden.li24")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li25")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li26")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li27")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li28")}</a></p></li>
                                        <li><p><a href="">{t("tvgarden.li29")}</a></p></li>
                                    </ul>
                                </li>
                                <li><p><a href="">{t("tvgarden.li30")}</a></p></li>
            ...
            <div className="xl:max-w-7xl 3xs:max-sm:w-9/10 mx-auto bg-[#1a202c]">
                <div className="p-4 *:mt-8">
                    ...
                    <p>{t("tvgarden.intro3_1")}<a href="" className="text-[#2bba3f] cursor-pointer underline">{t("tvgarden.intro3_2")}</a>{t("tvgarden.intro3_3")}</p>
                </div>
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn1")}</button></div>
                <div className="p-4 *:mt-8">
                    <p>{t("tvgarden.intro4")}</p>
                    <p>{t("tvgarden.intro5_1")}<a href="" className="text-[#2bba3f] cursor-pointer underline">{t("tvgarden.intro5_2")}</a>{t("tvgarden.intro5_3")}</p>
                ...
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn2")}</button></div>
                <div className="pl-4">
                    <ul className="pl-2 list-disc *:py-2">
                        <li>t{t("tvgarden.listText1_1")}<a href="" className="text-[#2bba3f] cursor-pointer underline">{t("tvgarden.listText1_2")}</a>{t("tvgarden.listText1_3")}</li>
                ...
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn3")}</button></div>
                <div className="px-4">
                    <p>{t("tvgarden.feature")}</p>
                    <div className="mt-5 flex flex-wrap gap-10">
                        {Array.from([image5,image6,image7,image8,image9,image10,image11,image12,image13]).map((img,i)=><div key={i} style={{backgroundColor:'linear-gradient(145deg,#222,#222)',boxShadow:'10px 10px 19px #1c1e2252,-10px -10px 19px #262a2e00'}} className={classNames(pageAttr.device.isDesktop?"flex-1/4":"grow","transition-all duration-[0.4s] ease-in-out pt-10 pb-10 border-solid border rounded-md border-black hover:border-[#79c447] hover:bg-[linear-gradient(145deg,#000,#222)] px-6 text-center")}>
                ...
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn4")}</button></div>
                <div className="px-4">
                ...
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn5")}</button></div>
                ...
                <div className="my-6 flex text-center"><button className="rounded-full text-base bg-[#79c744] px-6 font-medium py-3 mx-auto cursor-pointer">{t("tvgarden.introBtn6")}</button></div>
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn7")}</button></div>
                <div className="p-2">
                    <p>{t("tvgarden.step")}</p>
                ...
                <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn8")}</button></div>
                 <div>
                    <p className="p-2 mb-8">{t("tvgarden.how")}</p>
                    <ul className="mx-auto w-8/10 list-disc [&_li]:py-2 [&_li_span]:font-bold">
                        <li><span>{t("tvgarden.howli1.bold")}</span>{t("tvgarden.howli1.txt1")}<i className="text-[#2bba3f] cursor-pointer">https://tvgarden.net/</i>{t("tvgarden.howli1.txt2")}</li>
                 ...
                 <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn9")}</button></div>
                 <div>
                    ...
                    <ul className="mx-auto w-8/10 list-disc [&_li]:py-2 [&_li_span]:font-bold">
                        ...
                        <li><span>{t("tvgarden.bestli5.bold")}</span>{t("tvgarden.bestli5.txt1")}<a className="text-[#2bba3f] cursor-pointer underline" href="">{t("tvgarden.bestli5.txt2")}</a>{t("tvgarden.bestli5.txt3")}</li>
                    </ul>
                 </div>
                 <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">FAQ</button></div>
                 <div>
                    {Array.from([t("tvgarden.faq1"),t("tvgarden.faq2"),t("tvgarden.faq3"),t("tvgarden.faq4"),t("tvgarden.faq5")]).map((faq , ix)=><div key={ix}>
                        <div className="px-2">
                            <p className="after:content-['+'] after:block after:font-bold flex justify-between p-4 border border-solid my-5">{faq}</p>
                        </div>
                    </div>)}
                 </div>
                 <div className="w-auto text-center py-6"><button className="bg-[#79c744] px-6 text-2xl font-medium py-3 mx-auto rounded-md w-[calc(100%)] cursor-pointer">{t("tvgarden.introBtn10")}</button></div>
